...
export default class OptionsPopover extends React.Component {
  ...
  handleClear(event) {
    ...
    this.filterInput.current.dispatchEvent(
        ...
        <Popover.Content>
          <InputGroup>
            ...
            <InputGroup.Append>
              <Button
                ...
                style={{ minWidth: "2rem", padding: "0px" }}
          ...
          <InputGroup className="mt-2">
            <Button
              ...
              style={{ minWidth: "2rem", padding: "0px" }}
              size="lg"
              active={this.props.sort === 1}
              title="По возрастанию"
              onClick={() => this.props.handleSortChange(this.props.num, 1)}
            >
              ⤋
            </Button>
            <Button
            ...
            <Button
              ...
              style={{ minWidth: "2rem", padding: "0px" }}
              size="lg"
              active={this.props.sort === 0}
              title="Без сортировки"
              onClick={() => this.props.handleSortChange(this.props.num, 0)}
            >
              ⇋
            </Button>
          </InputGroup>
    ...
    return (
      <>
        <Button
          ...
          variant="light"
          size="sm"
          active={this.props.filter || this.props.sort}
